...
public class ResultSetProxy implements ResultSet, Proxy {
	...
	public ResultSetProxy(StatementProxy parent, ResultSet realResultSet) {
	...
	public <T> T unwrap(Class<T> iface) throws SQLException {
		...
		try {
			return (T) reportReturn(methodCall, (iface != null && (iface == ResultSet.class || iface == Proxy.class)) ? (T) this : realResultSet
					.unwrap(iface));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
	...
	public boolean isWrapperFor(Class<?> iface) throws SQLException {
		...
		try {
			return reportReturn(methodCall, (iface != null && (iface == ResultSet.class || iface == Proxy.class))
