 ...
 * @create [2017-04-12]
 */
public class StatementProxy implements Statement, Proxy {

    protected final ProxyLogDelegator log;
    ...
    public StatementProxy(ConnectionProxy connectionProxy, Statement realStatement) {
        if (realStatement == null) {
            throw new IllegalArgumentException("Must pass in a non null real Statement");
        }
        if (connectionProxy == null) {
            throw new IllegalArgumentException("Must pass in a non null ConnectionProxy");
        }
    ...
    public Integer getConnectionNumber() {
        return connectionProxy.getConnectionNumber();
    }
    ...
    public Connection getConnection() throws SQLException {
        ...
        return (Connection) reportReturn(methodCall, connectionProxy);
    }
    ...
    public ResultSet getGeneratedKeys() throws SQLException {
        ...
        try {
            ...
            if (r == null) {
                ...
                return (ResultSet) reportReturn(methodCall, new ResultSetProxy(this, r));
            }
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ...
        try {
            ...
            reportStatementSqlTiming(System.currentTimeMillis() - tstart, sql, methodCall);
            ResultSetProxy r = new ResultSetProxy(this, result);
            return (ResultSet) reportReturn(methodCall, r);
        } catch (SQLException s) {
            reportException(methodCall, s, sql, System.currentTimeMillis() - tstart);
            throw s;
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            return (T) reportReturn(methodCall, (iface != null && (iface == Connection.class || iface == Proxy.class)) ? (T) this : realStatement
                    .unwrap(iface));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        try {
            return reportReturn(methodCall, (iface != null && (iface == Statement.class || iface == Proxy.class))
