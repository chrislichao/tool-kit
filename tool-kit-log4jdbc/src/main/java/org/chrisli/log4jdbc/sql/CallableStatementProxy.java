...
public class CallableStatementProxy extends PreparedStatementProxy implements CallableStatement {
	...
	public CallableStatementProxy(String sql, ConnectionProxy connectionProxy, CallableStatement realCallableStatement) {
	...
	public Object getObject(int parameterIndex, Map<String, Class<?>> map) throws SQLException {
		String methodCall = "getObject(" + parameterIndex + ", " + map + ")";
		try {
	...
	public <T> T unwrap(Class<T> iface) throws SQLException {
		...
		try {
			return (T) reportReturn(methodCall, (iface != null && (iface == CallableStatement.class || iface == PreparedStatement.class
					|| iface == Statement.class || iface == Proxy.class)) ? (T) this : realCallableStatement.unwrap(iface));
		} catch (SQLException s) {
			reportException(methodCall, s);
			throw s;
		}
	...
	public boolean isWrapperFor(Class<?> iface) throws SQLException {
		...
		try {
			return reportReturn(methodCall, (iface != null && (iface == CallableStatement.class || iface == PreparedStatement.class
					|| iface == Statement.class || iface == Proxy.class))
