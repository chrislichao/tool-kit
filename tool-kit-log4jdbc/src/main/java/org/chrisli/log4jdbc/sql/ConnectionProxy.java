...
public class ConnectionProxy implements Connection, Proxy {
    ...
    public ConnectionProxy(Connection realConnection, RdbmsSpecifics rdbmsSpecifics) {
        if (rdbmsSpecifics == null) {
            rdbmsSpecifics = DriverProxy.defaultRdbmsSpecifics;
        }
    ...
    private static final Map<Integer, ConnectionProxy> connectionTracker = new HashMap<Integer, ConnectionProxy>();
    ...
    public Statement createStatement() throws SQLException {
        ...
        try {
            ...
            return (Statement) reportReturn(methodCall, new StatementProxy(this, statement));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        ...
        try {
            ...
            return (PreparedStatement) reportReturn(methodCall, new PreparedStatementProxy(sql, this, statement));
        } catch (SQLException s) {
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        ...
        try {
            ...
            return (CallableStatement) reportReturn(methodCall, new CallableStatementProxy(sql, this, statement));
        } catch (SQLException s) {
            reportException(methodCall, s, sql);
            throw s;
        }
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            return (T) reportReturn(methodCall, (iface != null && (iface == Connection.class || iface == Proxy.class)) ? (T) this : realConnection
                    .unwrap(iface));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        try {
            return reportReturn(methodCall, (iface != null && (iface == Connection.class || iface == Proxy.class))
